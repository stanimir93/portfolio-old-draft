        ...
        <main>
            <section className='w-full max-w-screen-lg '>
                <div className='bg-white rounded py-28 px-16 mt-24 shadow-md shadow-slate-300 '>
                    ...
                    <img
                        className=' rounded  float-left md:float-right  h-56'
                        src='./images/profile.webp'
                        alt='profile_photo'
                    ></img>
                    {/* </div> */}

                    <h1 className='text-5xl rounded font-bold mb-12 '>STANIMIR NIKOLOV</h1>
                    <h3 className='text-3xl font-semibold mb-4 '>Web Developer</h3>
                    <h6 className=' '>JavaScript, CSS, HTML, React, Node, Express, SQL</h6>
